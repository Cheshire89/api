...
const worker = {};
const validateChecksWorker = {};

// check timer in seconds
const timer = 5;
...
worker.processCheckOutcome = (checkData, checkOutcome) => {
    ...
    console.log(checkOutcome, state, alertWaranted)
...
worker.loop = () => {
    setInterval(() => worker.gatherAllChecks(), 1000 * timer)
};
...
module.exports = validateChecksWorker;